...
// Copied from https://github.com/microsoft/vscode-debugadapter-node/blob/master/protocol/src/debugProtocol.ts
// to avoid this issue for now: https://github.com/jupyterlab/jupyterlab/issues/6911
